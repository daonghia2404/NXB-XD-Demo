...
const readMorePayment = {
  ...
  readMorePayment: function () {
    ...
    const infoListItem = $(".info-partner__right-list .list__item:last-child");
...
const partnerAuthor = {
  ...
  partnerAuthorSlider: function () {
    ...
    $(window).on("resize load", function () {
      ...
      if (wightScreen < 767) {
        $(".partner-author .partner-author__slider .owl-nav .owl-next").html(
          '<img src="assets/images/arrowrmb.svg" alt="">'
        );
      } else {
        $(".partner-author .partner-author__slider .owl-nav .owl-next").html(
          '<img src="assets/images/nextsl.svg" alt="">'
...
const pdf = {
  ...
  config: function () {
    const pdfViews = document.querySelectorAll(".pdf-view");
